...
export class OrderEndPoint {
  ...
  postOrder(requestStateUpdater: StoreRequestStateUpdater, order: Order) {
  ...
  putOrder(requestStateUpdater: StoreRequestStateUpdater, order: Order) {
  ...
  getOrder(order_id: string, requestStateUpdater: StoreRequestStateUpdater) {
  ...
  getOrders(requestStateUpdater: StoreRequestStateUpdater) {
    const options = getHeadersForNewOrders();
