...
@NgModule({
  declarations: [BuyerAccountsComponent, AddRetailerModalComponent],
  imports: [CommonModule, SharedModule, BuyerAccountsRoutingModule],
  providers: [AuthenticationStore, BuyerAccountEndPoint, BuyerAccountStore],
